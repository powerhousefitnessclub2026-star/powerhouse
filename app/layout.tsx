...
export const metadata: Metadata = {
  ...
  description:
    'Power House Fitness Club — luxury unisex gym with biomechanical equipment, CrossFit rigs, HIIT training, master coaching & personalized workout plans in Erode.',
  keywords: [
